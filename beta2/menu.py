    ...
    def displayScreen(self):
        ...
        while self.displayRunning:
            ...
            if self.buttonHost.isButtonClick():
                if self.network.tryConnectServer("192.168.30.1", 5555):
